...
python -m ksl_itops.agent.run --config config\agent.yml --policies config\policies.yml
ดูข้อมูลที่ถูกเก็บ
http://127.0.0.1:8000/api/v1/segments
http://127.0.0.1:8000/api/v1/machine/<hostname>/latest